...
import { checkSchemaDivergence, formatLaunchSchemaWarning } from '../utils/schemaWriter.js';
 ...
 */
async function warnUndeployedChanges(customizations, env) {
    ...
    for (const custom of Object.values(customizations)) {
        ...
        try {
            ...
            try {
                ...
                const entry = (statusResp.apps ?? []).find((a) => String(a.app) === appId);
