...
import { generateReadme } from '../../gen/docsGenerator.js';
/**
 ...
 */
export async function schemaDocs(options) {
    ...
    const fieldsEnv = options.env === 'prod' ? 'prod' : 'dev';
    const otherEnv = fieldsEnv === 'dev' ? 'prod' : 'dev';
    const appsData = [];
