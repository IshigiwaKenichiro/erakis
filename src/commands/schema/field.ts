...
export function parseFieldsInput(
    ...
    if ('properties' in obj && obj.properties !== null && typeof obj.properties === 'object' && !Array.isArray(obj.properties)) {
        return obj.properties as Record<string, any>;
    }
    // 素のマップ形式: { "fieldCode": {...}, ... }
 ...
 * LIVE preview 読み取り専用。
 */
export async function schemaGetField(
 ...
 */
export async function schemaCreateField(
    appRef: string | undefined,
    filePath: string | undefined,
 ...
 */
export async function schemaUpdateField(
    appRef: string | undefined,
    filePath: string | undefined,
    options: { env?: string; profile?: string; yes?: boolean },
): Promise<void> {
 ...
 */
export async function schemaDeleteField(
    appRef: string | undefined,
    fieldCodes: string[],
    options: { env?: string; profile?: string; yes?: boolean },
): Promise<void> {
